  ...
  return (
    <div className="min-h-screen bg-[#F9FAFB]">
      ...
      <main id="main-content" className="max-w-[1400px] mx-auto px-6 py-5">
        {activeTab === "summary"   && <ReviewSummaryTab   key={propertyId} propertyId={propertyId} />}
        {activeTab === "inbox"     && <InboxTab           key={propertyId} propertyId={propertyId} />}
        {activeTab === "analytics" && <ReviewAnalyticsTab key={propertyId} propertyId={propertyId} />}
        {activeTab === "settings"  && (
